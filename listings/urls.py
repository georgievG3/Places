...
from listings.views import ListingDetailsView, DeleteImageView, ListingsByCategoryView, CommentCreateView
...
urlpatterns = [
    ...
    path('listing/<slug:slug>/comment/add/', CommentCreateView.as_view(), name='add-comment'),
